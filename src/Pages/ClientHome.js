        ...
        <div className="flex flex-col">
            ...
            <div className=" w-72 mx-auto lg:w-4/5 mt-40 lg:mt-60 relative flex justify-center ">
                <CardContainer title="Our services" subtitle="Excellence in Diverse Legal Disciplines" >
                    ...
                    <Card name="Mediators" src="./img/logo/MediatorLogo.png" scale="100px"/>
                    <Card name="Document Writers" src="./img/logo/DocumentWriterLogo.png" scale="70px"/>
                    <Card name="Consultants" src="./img/logo/ConsultantLogo.png" scale="100px"/>
                </CardContainer>
            </div>   
        </div>
    )
