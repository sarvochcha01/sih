    ...
    return( 
        <div>
            ...
            <div className="h-10 w-full flex justify-center mt-2 px-8 md:px-96">
                    ...
                    <div className="details flex flex-col-reverse lg:flex-row h-4/5 sm:justify-evenly">
                        <div className="personal basis-8/12 sm:ml-20">
                            ...
                            <div className="DOB flex flex-col justify-between sm:h-auto mt-3 mb-8">
                                ...
                                <input type="text" className="rounded-xl border-2 border-slate-700 h-8  w-full float-right sm:h-24 cursor-auto"
                ...
                <input onClick={() => props.pfun()} type="button" value="Back" className="bg-gray-300 border-2 border-slate-400 rounded-lg w-5/12 md:w-3/12 h-10 text-xl font-extrabold"/>
